...
class FormationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formation" do
    assert_difference('Formation.count') do
      post formations_url, params: { formation: { content: @formation.content, title: @formation.title } }
    end
  ...
  test "should update formation" do
    patch formation_url(@formation), params: { formation: { content: @formation.content, title: @formation.title } }
